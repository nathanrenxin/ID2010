    ...
    Runnable			// for the distribution thread.
{
   ...
   */
  protected LinkedList<ChatMessage> msgQueue = new LinkedList<ChatMessage> ();
  ...
  protected void addMessage (ChatMessage msg) {
    ...
    msgCount++;
    System.out.println ("MSG#" + msgCount + ":" + msg.getText());
   ...
   */
  protected ChatMessage getNextMessage () {
    if (msgQueue.isEmpty())
      return null;
  ...
  @Override
  public void say (ChatMessage msg) throws RemoteException
  {
    if (msg != null) {
      addMessage (msg);
    }
  ...
  public void run () {
    ...
    while (runDelivery) {
      ...
      ChatMessage msg = getNextMessage ();
      if (msg != null) {
